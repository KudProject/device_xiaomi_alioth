...
void vendor_load_properties()
{
    ...
    char const *description = "alioth-user 12 RKQ1.200826.002 V13.0.6.0.SKHCNXM release-keys";
    char const *fingerprint = "Redmi/alioth/alioth:12/RKQ1.200826.002/V13.0.6.0.SKHCNXM:user/release-keys";
